<?php
/**
 * IT Staff Equipment Page - Lab Management System
 */
...
<head>
    ...
    <title>Equipment Management - Lab Management System</title>
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        <p class="text-gray-600">IT equipment management and monitoring functionality will be implemented here.</p>
                    </div>
                </div>
            </main>
        </div>
