...
$navigation_items = [
    'student' => [
        ...
        ['name' => 'My Courses', 'href' => '#', 'icon' => 'academic-cap'],
        ['name' => 'Lab Schedule', 'href' => '#', 'icon' => 'calendar'],
        ['name' => 'Equipment Booking', 'href' => '#', 'icon' => 'desktop-computer'],
        ['name' => 'Attendance', 'href' => '#', 'icon' => 'check-circle'],
        ['name' => 'Assignments', 'href' => '#', 'icon' => 'document-text'],
        ['name' => 'Profile', 'href' => '#', 'icon' => 'user'],
    ],
    'professor' => [
        ['name' => 'Dashboard', 'href' => '#', 'icon' => 'home', 'active' => true],
        ['name' => 'My Classes', 'href' => '#', 'icon' => 'academic-cap'],
        ['name' => 'Lab Sessions', 'href' => '#', 'icon' => 'beaker'],
        ['name' => 'Students', 'href' => '#', 'icon' => 'users'],
        ['name' => 'Schedule', 'href' => '#', 'icon' => 'calendar'],
        ['name' => 'Equipment', 'href' => '#', 'icon' => 'desktop-computer'],
        ['name' => 'Attendance', 'href' => '#', 'icon' => 'clipboard-check'],
        ['name' => 'Reports', 'href' => '#', 'icon' => 'chart-bar'],
        ['name' => 'Profile', 'href' => '#', 'icon' => 'user'],
    ],
    'itstaff' => [
        ['name' => 'Dashboard', 'href' => '#', 'icon' => 'home', 'active' => true],
        ['name' => 'Equipment Management', 'href' => '#', 'icon' => 'desktop-computer'],
        ['name' => 'Maintenance Requests', 'href' => '#', 'icon' => 'exclamation-triangle'],
        ['name' => 'Lab Rooms', 'href' => '#', 'icon' => 'office-building'],
        ['name' => 'User Management', 'href' => '#', 'icon' => 'users'],
        ['name' => 'System Health', 'href' => '#', 'icon' => 'status-online'],
        ['name' => 'Inventory', 'href' => '#', 'icon' => 'clipboard-list'],
        ['name' => 'Reports', 'href' => '#', 'icon' => 'chart-bar'],
    ...
    'admin' => [
        ['name' => 'Dashboard', 'href' => '#', 'icon' => 'home', 'active' => true],
        ['name' => 'User Management', 'href' => '#', 'icon' => 'users'],
        ['name' => 'Lab Management', 'href' => '#', 'icon' => 'beaker'],
        ['name' => 'Equipment', 'href' => '#', 'icon' => 'desktop-computer'],
        ['name' => 'System Settings', 'href' => '#', 'icon' => 'cog'],
        ['name' => 'Database Backup', 'href' => '#', 'icon' => 'database'],
        ['name' => 'System Logs', 'href' => '#', 'icon' => 'document-text'],
        ['name' => 'Reports', 'href' => '#', 'icon' => 'chart-bar'],
        ['name' => 'Permissions', 'href' => '#', 'icon' => 'shield-check'],
    ]
];
