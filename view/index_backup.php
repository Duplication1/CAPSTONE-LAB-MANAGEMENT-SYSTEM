...
<body class="login-container">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <!-- Staff/Faculty Login Form (Hidden by default) -->
            <div id="staffLoginForm" class="bg-white rounded-lg shadow-2xl p-8 hidden">
                <div class="mb-4">
                    <button onclick="showLoginTypes()" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-6 text-center">Staff/Faculty Login</h3>
    ...
    <script>
        function showStudentLogin() {
            document.querySelector('.bg-white.rounded-lg.shadow-2xl').style.display = 'none';
        ...
        function showLoginTypes() {
            document.querySelector('.bg-white.rounded-lg.shadow-2xl').style.display = 'block';
            document.getElementById('studentLoginForm').classList.add('hidden');
            document.getElementById('staffLoginForm').classList.add('hidden');
        }

        // Show appropriate form based on previous submission
        document.addEventListener('DOMContentLoaded', function() {
            <?php if (isset($_POST['login_type']) && $_POST['login_type'] === 'student'): ?>
                showStudentLogin();
            <?php elseif (isset($_POST['login_type']) && $_POST['login_type'] === 'staff'): ?>
                showStaffLogin();
            <?php endif; ?>
        });
    </script>
